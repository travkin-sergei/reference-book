# Generated by Django 5.0.7 on 2025-02-14 15:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now_add=True, db_comment='{"name":"Строка в базе данных обновлена.",}', help_text='Дата обновления строки в текущей базе данных.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.CharField(blank=True, db_comment='{"name":"URL ссылка.",}', help_text='URL ссылка.', max_length=255, null=True, verbose_name='URL.')),
                ...
                ('comment', models.TextField(blank=True, db_comment='{"name":"Описание ресурса",}', help_text='Описание ресурса.', null=True, verbose_name='Комментарий')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_table', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='my_data_asset.datatable')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='my_data_asset.datavalue')),
            ],
            options={
                'verbose_name': '04 Столбец таблицы',
                'verbose_name_plural': '04 Столбцы таблицы',
                'db_table': 'data_value',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now_add=True, db_comment='{"name":"Строка в базе данных обновлена.",}', help_text='Дата обновления строки в текущей базе данных.')),
                ('is_active', models.BooleanField(db_comment='{"name":"Стока в базе данных активна.",}', default=True, help_text='Является ли запись действующей на текущей момент?')),
                ('data_assets', models.ForeignKey(help_text='Группировка источников данны.', on_delete=django.db.models.deletion.CASCADE, related_name='related_assets', to='my_data_asset.dataasset', verbose_name='Группировка источников данных.')),
                ('name', models.ForeignKey(help_text='Группировка источников данны.', on_delete=django.db.models.deletion.CASCADE, related_name='related_group', to='my_data_asset.dataassetgroup', verbose_name='Группировка источников данных.')),
            ],
            options={
                'verbose_name': '__ Группа источников',
                'verbose_name_plural': '__ Группы источников',
