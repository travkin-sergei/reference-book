...
class AssetDomainAdmin(BaseAdmin):
    list_display = ('name', 'description', 'link', 'is_active')
...
class AssetAdmin(BaseAdmin):
    list_display = ('type', 'domain', 'details', 'version', 'link', 'is_active')
    list_select_related = ('type', 'domain', 'details')
    search_fields = ('version', 'link', 'description',
                    'type__name', 'domain__name', 'details__name')
...
class AssetColumnAdmin(BaseAdmin):
    ...
    search_fields = ('name', 'data_type', 'description',
                    'asset__version', 'asset__type__name')
